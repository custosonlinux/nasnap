...
def _init_db():
    """Creates plugin tables in the central nasnap.db (idempotent).
    ...
    try:
        ...
        _add_column_if_missing(db, "netapp_snapshot_schedules", "tamperproof_enabled",    "INTEGER NOT NULL DEFAULT 0")
        _add_column_if_missing(db, "netapp_snapshot_schedules", "tamperproof_days",       "INTEGER NOT NULL DEFAULT 0")
        ...
        _add_column_if_missing(db, "netapp_instant_recovery_sessions", "new_name",    "TEXT NOT NULL DEFAULT ''")
        _add_column_if_missing(db, "netapp_instant_recovery_sessions", "protocol",    "TEXT NOT NULL DEFAULT 'nfs'")
        _add_column_if_missing(db, "netapp_instant_recovery_sessions", "san_state",   "TEXT NOT NULL DEFAULT ''")
